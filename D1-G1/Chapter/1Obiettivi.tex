...
\text{Il progetto ha come obiettivo la realizzazione di un sistema per la gestione ottimizzata dei rifiuti nella citt\`a di Trento, un'applicazione mobile per i cittadini e una web app per il comune. \\Lo scopo è fornire strumenti utili sia ai cittadini che agli operatori comunali per migliorare la raccolta e lo smaltimento dei rifiuti.
